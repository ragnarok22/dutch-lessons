...
\begin{itemize}[leftmargin=*]
	\item \textit{bij} suena \textipa{/bEi/}; evita /bi/.
	\item \textit{voor} mantiene vocal larga \textipa{/vo:r/}; no acortes.
\end{itemize}
...
\begin{itemize}[leftmargin=*]
	...
	\item Completa horarios con \textit{om/in/op} y rangos \textit{van\ldots{} tot\ldots{}}.

...
\textbf{Mini práctica}
\begin{itemize}[leftmargin=*]
  \item Niega la acción: \textit{Ik kook vanavond}. ➝ \textit{Ik kook vanavond niet.}
  \item Niega el lugar: \textit{Zij werkt in Amsterdam}. ➝ \textit{Zij werkt niet in Amsterdam.}
\end{itemize}

...
\begin{itemize}[leftmargin=*]
  ...
  \item Negación: \textit{niet} va antes del infinitivo.\ \textit{Ej.: Ik wil niet werken}.
  \item Pregunta de sí/no: el modal pasa a primera posición.\ \textit{Ej.: Kan jij komen?}
\end{itemize}

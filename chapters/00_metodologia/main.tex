...
\section*{Cinco técnicas fundamentales}

Estas cinco técnicas combinan input comprensible y producción activa. Úsalas de manera corta y frecuente.

\input{chapters/00_metodologia/sections/01_shadowing}
\input{chapters/00_metodologia/sections/02_bidirectional_translation}
\input{chapters/00_metodologia/sections/03_common_words_first}
\input{chapters/00_metodologia/sections/04_immersion}
\input{chapters/00_metodologia/sections/05_active_skills}

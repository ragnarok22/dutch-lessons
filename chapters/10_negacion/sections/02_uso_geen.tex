...
\textbf{Mini práctica}
\begin{itemize}[leftmargin=*]
  \item Transforma: \textit{Hij heeft een hond}. $\rightarrow$ \textit{Hij heeft geen hond.}
  \item Niega un plural sin artículo: \textit{Wij hebben tickets}. $\rightarrow$ \textit{Wij hebben geen tickets.}
\end{itemize}

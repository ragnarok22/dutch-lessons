...
\begin{itemize}[leftmargin=*]
  \item Niega con modal: \textit{Wij willen zwemmen}. $\rightarrow$ \textit{Wij willen niet zwemmen}.
  \item Con separable: \textit{Zij doet de lamp aan}. $\rightarrow$ \textit{Zij doet de lamp niet aan}.
\end{itemize}
